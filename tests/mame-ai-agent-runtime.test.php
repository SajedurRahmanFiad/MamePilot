...
$assert(str_contains($leadSource, "candidateModelRows") && str_contains($leadSource, 'rate limit') && str_contains($leadSource, 'return [$preferred]'), 'Lead analysis should keep the explicitly selected multimodal model authoritative when it is rate-limited.');
