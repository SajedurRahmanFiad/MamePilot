...
$assert(str_contains($leadSource, "candidateModelRows") && str_contains($leadSource, 'HTTP 429') && str_contains($leadSource, 'rate limit'), 'Lead analysis should fall back to other enabled multimodal models when the selected model is rate-limited.');
