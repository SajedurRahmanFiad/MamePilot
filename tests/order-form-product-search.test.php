...
orderProductSearchAssert(str_contains($backend, ':p_search_name') && str_contains($backend, ':b_search_name'), 'Product search must use unique PDO placeholders per UNION subquery.');
