    ...
    switch (key) {
      case 'admin.cashFlow': return (
        <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm md:p-8">
          <div className="mb-8 flex items-center justify-between"><h3 className="text-xl font-bold text-gray-900">Cash Flow</h3><div className="flex gap-4"><span className="flex items-center gap-2 text-xs font-bold uppercase text-gray-500"><i className="h-3 w-3 rounded-full bg-[#059669]" />Income</span><span className="flex items-center gap-2 text-xs font-bold uppercase text-gray-500"><i className="h-3 w-3 rounded-full bg-red-500" />Expense</span></div></div>
