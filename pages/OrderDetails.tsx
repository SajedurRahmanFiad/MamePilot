            ...
            capabilitySettings?.businessMode === 'vaccine_center' ? (
              <div className="rounded-lg px-4 py-4" style={{ backgroundColor: mixThemeColorWithWhite(themeColorHex, 0.94) }}>
                ...
                <div className="mt-3 grid grid-cols-[minmax(125px,1.2fr)_repeat(5,minmax(58px,1fr))] items-center">
                  <div className="min-w-0 pr-3"><h3 className="text-[10px] sm:text-xs font-black text-slate-900 break-words">{customer?.name}</h3><p className="mt-0.5 text-[9px] sm:text-[10px] font-medium text-gray-500">{customer?.phone}</p></div>
                  {([
              ...
              <div className="rounded-lg px-4 py-4" style={{ backgroundColor: mixThemeColorWithWhite(themeColorHex, 0.94) }}>
                ...
                <div className="mt-3 grid grid-cols-[max-content_minmax(0,1fr)] items-center gap-0">
                  ...
                  <div className="flex min-w-0 items-start gap-1.5 border-l border-gray-200 pl-3">
                    ...
                    <div className="invoice-address-content flex min-w-0 flex-col gap-0" style={{ rowGap: 0 }}><p className="m-0 text-[8px] sm:text-[9px] font-medium leading-tight text-gray-500" style={{ margin: 0, lineHeight: 1.1 }}>Address</p><p className="m-0 mt-0.5 text-[10px] sm:text-xs font-black leading-tight text-slate-900 whitespace-pre-line" style={{ margin: '0.125rem 0 0', lineHeight: 1.1 }}>{String(customer?.address || 'N/A').trim()}</p></div>
                  </div>
                </div>
              </div>
            )
