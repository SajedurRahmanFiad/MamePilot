...
final class FeatureAccess
{
    ...
    private const ACTION_CAPABILITIES = [
        ...
        'fetchProductsSearchPage' => 'inventory',
        ...
        'fetchPathaoCities' => 'pathao_courier',
        'fetchPathaoZones' => 'pathao_courier',
        'fetchPathaoAreas' => 'pathao_courier',
        ...
        'fetchSmsSettings' => 'sms',
        'updateSmsSettings' => 'sms',
        'fetchSmsBalance' => 'sms',
        'fetchSmsSummary' => 'sms',
        'fetchSmsHistory' => 'sms',
        'fetchSmsRechargeHistory' => 'sms',
        'initiateSmsRechargeCheckout' => 'sms',
        'sendSms' => 'sms',
