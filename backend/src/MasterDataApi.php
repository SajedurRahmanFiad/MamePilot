...
final class MasterDataApi extends BaseService
{
    ...
    public function fetchCourierSettings(array $params = []): array
    {
        ...
        return [
            ...
            'steadfast' => [
                ...
                'webhookAuthToken' => (string) ($row['steadfast_webhook_auth_token'] ?? ''),
                'invoice' => (string) ($row['steadfast_invoice'] ?? ''),
                'defaultAccountId' => (string) ($row['steadfast_default_account_id'] ?? ''),
                'defaultExpenseCategoryId' => (string) ($row['steadfast_default_expense_category_id'] ?? ''),
                'defaultIncomeCategoryId' => (string) ($row['steadfast_default_income_category_id'] ?? ''),
                'defaultPaymentMethod' => (string) ($row['steadfast_default_payment_method'] ?? ''),
            ],
            'carryBee' => [
                ...
                'defaultPaymentMethod' => (string) ($row['carrybee_default_payment_method'] ?? ''),
            ],
            'paperfly' => [
                ...
                'defaultAccountId' => (string) ($row['paperfly_default_account_id'] ?? ''),
                'defaultExpenseCategoryId' => (string) ($row['paperfly_default_expense_category_id'] ?? ''),
                'defaultIncomeCategoryId' => (string) ($row['paperfly_default_income_category_id'] ?? ''),
            ...
            'pathao' => [
                ...
                'defaultPaymentMethod' => (string) ($row['pathao_default_payment_method'] ?? ''),
            ],
        ];
    }
    ...
    public function updateCourierSettings(array $params): array
    {
        ...
        $updates = [
            ...
            'steadfast_webhook_auth_token' => $steadfast['webhookAuthToken'] ?? $current['steadfast']['webhookAuthToken'],
            ...
            'steadfast_default_payment_method' => $this->nullableString($steadfast['defaultPaymentMethod'] ?? $current['steadfast']['defaultPaymentMethod'] ?? null),
            ...
            'carrybee_default_payment_method' => $this->nullableString($carryBee['defaultPaymentMethod'] ?? $current['carryBee']['defaultPaymentMethod'] ?? null),
            ...
            'paperfly_default_account_id' => $this->nullableString($paperfly['defaultAccountId'] ?? $current['paperfly']['defaultAccountId'] ?? null),
            'paperfly_default_expense_category_id' => $this->nullableString($paperfly['defaultExpenseCategoryId'] ?? $current['paperfly']['defaultExpenseCategoryId'] ?? null),
            'paperfly_default_income_category_id' => $this->nullableString($paperfly['defaultIncomeCategoryId'] ?? $current['paperfly']['defaultIncomeCategoryId'] ?? null),
            'paperfly_default_payment_method' => $this->nullableString($paperfly['defaultPaymentMethod'] ?? $current['paperfly']['defaultPaymentMethod'] ?? null),
