...
final class MessengerApi extends BaseService
{
    ...
    private function ensureTables(): void
    {
        ...
        if ($this->tableExists('messenger_contacts') && !$this->columnExists('messenger_contacts', 'last_message_direction')) $this->database->execute("ALTER TABLE messenger_contacts ADD COLUMN last_message_direction VARCHAR(16) NULL AFTER last_message_type");
