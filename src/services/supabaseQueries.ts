...
export async function updateInvoiceSettings(updates: { logoWidth?: number; logoHeight?: number; footer?: string; }) { return call<any>('updateInvoiceSettings', updates); }
...
export async function refreshMessengerContactProfile(contactId: string): Promise<MessengerContact> { return call<MessengerContact>('refreshMessengerContactProfile', { contactId }); }
...
export async function fetchPathaoCities(params?: { baseUrl?: string; accessToken?: string }) { return call<Array<{ id: string; name: string }>>('fetchPathaoCities', params); }
export async function fetchPathaoZones(params: { cityId: string; baseUrl?: string; accessToken?: string }) { return call<Array<{ id: string; name: string }>>('fetchPathaoZones', params); }
export async function fetchPathaoAreas(params: { zoneId: string; baseUrl?: string; accessToken?: string }) { return call<Array<{ id: string; name: string }>>('fetchPathaoAreas', params); }
