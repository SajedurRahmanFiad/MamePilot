...
export const DASHBOARD_WIDGET_DEFINITIONS: DashboardItemDefinition[] = [
  ...
  { key: 'admin.topSoldProducts', label: 'Top 5 Sold Items', description: 'Best-selling items by quantity.', scope: 'admin', defaultFor: ['admin'], width: 'half' },
  ...
  { key: 'admin.lowStockProducts', label: 'Low Stock Items', description: 'Inventory items and batches at or below the low-stock threshold.', scope: 'admin', defaultFor: [], requiredCapabilities: ['inventory'], width: 'half' },
